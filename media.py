...
# This script contains class descriptions for 'Video', 'Movie', and 'TvShow
# author: Xiang Zhao

# need the webbrowser library to open URLs
import webbrowser

# Class Video is parent for both Movie and TvShow
# Contains attributes title and duration
...
# Class Movie inherits from class Video. Use to create Movie instances
...
# Class TvShow inherits form class Video. Use to create TvShow instances


class TvShow(Video):

    def __init__(self, title, duration, show_storyline,
