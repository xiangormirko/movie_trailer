...
# description: Part of the movie trailer website project. This script creates instances of class Movie and TvShows and calls fresh_tomatoes.py to generate website
# author: Xiang Zhao


#imports media.py which contains class specificaitons. imports fresh_tomatoes.py to generate the website with bootstrap framework
import media
import fresh_tomatoes


#Instances of type Movie and TvShow are creted here. For more details, consult media.py. 
